...
export default function Pete2({ step }) {
            ...
            <div className="container2">
                <Form className="formGeneral">
                    ...
                    <div className="riskInfo">
                        <img src="/waterLevelPete1.png" width="300px" />
                    </div>
                </Form>
                <Form className="formGeneral">
                    <h2>Message from Emergency Manager</h2>
                    <div className="messageBox">
                        <p>Keep power on. Many people
                            are still at home
                        </p>
                    </div>
                </Form>
                ...
                <Form className="formGeneral">
                    ...
                    <Form.Group>
                        <div>
                            <Form.Label htmlFor={`radio`}>You check flood risk information. What is your decision?</Form.Label>
                            <Radio label='Shut down' name="questionPete2" />
                            <Radio label='Keep providing electricity service' name="questionPete2" />
                        </div>
                    </Form.Group>

                    <Link to="/Pete3"><Button>Submit</Button></Link>

                    <div className="graymap">
                        <img src="/graymapPete.png" width="400px"/>
                    </div>
                </Form>
            </div>
        </>

...
export default function Norman3({ step }) {
        ...
        <>
            <div className="container2">
                ...
                <Form className="formGeneral">
                    ...
                    <Form.Group>
                        <div>
                            <Form.Label htmlFor={`questionNorman3`}>Which way are you going to take?</Form.Label>
                    ...
                    <Link to="/norman4"><Button>Submit</Button></Link>

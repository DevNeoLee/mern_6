...
export default function Norman2({ step }) {
            ...
            <div className="container2">
                <Form className="formGeneral">
                    ...
                    <div className="riskInfo">
                        <img src="/waterDepth.png" width="300px"/>
                    </div>
                </Form>
                <Form className="formGeneral">
                    <h2>Message from Emergency Manager</h2>
                    <div className="messageBox">
                        <p>"Route C" has high flooding and
                ...
                <Form className="formGeneral">
                    <h2>Electricity/Power Status</h2>
                    <div className="upperForm">
                        <div className="logo">
                            <img src="/powerOutrage.png" />
                        </div>
                        <div className="logo">
                ...
                <Form className="formGeneral">
                    ...
                    <Link to="/norman3"><Button>Submit</Button></Link>
